...
public class Transaction {
    ...
    public static void test()
        ...
        Transaction tx = new Transaction(new TxInputList(),
                new TxOutputList());
        tx.testCase("Transaction null to null", pubKeyMap);
        tx = new Transaction(new TxInputList(pubKeyA, 10, signedMessage1),
                new TxOutputList(pubKeyB, 5));
        tx.testCase("Transaction Alice 10  to Bob 5", pubKeyMap);


        tx = new Transaction(new TxInputList(pubKeyA, 5, signedMessage1),
                new TxOutputList(pubKeyB, 10));
   ...
   // return the list of txOutputs
    ...
    public boolean checkSignaturesValid() {
        return this.txInputs.checkSignature(this.txOutputs);
    ...
    // Generic Test cases, providing a headline printing out the
    //  transaction and printing out whether it is valid.
