...
public class TxOutputList {
    ...
    public TxOutputList(PublicKey sender1, int amount1,
     ...
     * <p>
     * We don't need it really since it is only used for checking in case of txInputs
    ...
    /**
     * function  to print all items in the TxOutputList
     * in the form
     ...
     * printing out the TxOutputList
     * and printing out the sum of amounts in the TxOutputList
     */
