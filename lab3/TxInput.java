...
public class TxInput {
    ...
    */
    ...
    /**
     * Create the corresponding element of TxInputUnsigned
     ...
     * each output.
     * It is computed in the method getMessageToSign  of TxInputList.java)
     * <p>
    ...
    public boolean checkSignature(TxOutputList txol) {
        return new TxInputUnsigned(this.sender,this.amount).checkSignature(txol,this.signature);
